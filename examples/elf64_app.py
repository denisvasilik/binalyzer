...
if __name__ == "__main__":
    ...
    print("EI_CLASS (32-Bit or 64-Bit): " + to_hex(elf.elf_header.e_ident.EI_CLASS.value))
    print("EI_DATA (endianess): " + to_hex(elf.elf_header.e_ident.EI_DATA.value))
    print("EI_VERSION (ABI, UNIX System V ABI): " + to_hex(elf.elf_header.e_ident.EI_VERSION.value))
